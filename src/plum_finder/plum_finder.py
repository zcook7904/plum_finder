...
from API_handling import get_key, get_geolocation, create_client
...
def load_SF_streets(street_name_path: str = ".//data//Street_Names.json"):
...
def find_closest_plum(user_address, n=10):
    ...
    # load tree data
    tree_data_path = os.path.join('.', 'data', 'Plum_Street_Tree_List.csv')
